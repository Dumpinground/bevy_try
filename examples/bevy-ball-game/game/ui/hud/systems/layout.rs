...
pub fn build_hud(commands: &mut Commands, asset_server: &Res<AssetServer>) -> Entity {
    let hud_entity = commands.spawn((NodeBundle {
        ...
        parent.spawn(NodeBundle {
            ...
            parent.spawn((
                TextBundle {
                    text: Text { sections: vec![TextSection::new("0", get_text_style(&asset_server))], alignment: TextAlignment::Center, ..default() },
                    ..default()
                }, ScoreText {}
            ));
        });
        ...
        parent.spawn(NodeBundle {
            ...
            parent.spawn(ImageBundle {
                style: IMAGE_STYLE,
                image: asset_server.load("ball-game/sprites/ball_red_large.png").into(),
                ..default()
            });
        });
